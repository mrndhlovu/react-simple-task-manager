...
export const requestCreateTask = (data) =>
  axiosInstance.post(`${TASKS_EP}/create-task`, data);

export const requestCreateList = (data) =>
  axiosInstance.post(`${TASKS_EP}/create-list`, data);

export const requestUpdateTask = (data, id) =>
  axiosInstance.patch(`${TASKS_EP}/id/${id}/update-task`, data);

export const requestTask = (id) => axiosInstance.get(`${TASKS_EP}/id/${id}`);
export const requestList = (id) =>
  axiosInstance.get(`${TASKS_EP}/id/${id}/list`);

export const requestUpdateList = (data, id) =>
  axiosInstance.patch(`${TASKS_EP}/id/${id}/update-list`, data);
